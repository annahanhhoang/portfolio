        ...
        <v-timeline-item v-for="item in experiences" :key="item.id" class="timeline-item">
          ...
          <v-card class="elevation-2">
            <div class="timeline-title pa-3">
              ...
              <div class="timeline-company-overview">{{ item.companyOverview }}</div>
            </div>
  ...
  data: () => ({
    ...
    experiences: [
      ...
      },
      {
        ...
        companyOverview: '',
        responsibility:
          'Responsile for designing and developing an internal website to manage trades reject queue.',
        tech: ['Java', 'JSF', 'DB2'],
      },
    ],
  }),
